  ...
  return (
    ...
    >
        ...
        <div className="d-flex border-bottom" id='message-row' key={message.user+idx}>
            <svg width="2.5em" height="2.5em" viewBox="0 0 16 16" className="bi bi-person-fill d-flex flex-column m-3 align-self-start border" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
