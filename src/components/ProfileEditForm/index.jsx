  ...
  return (
    <div className="d-flex justify-content-center mt-5">
        <div className="card" style={{width: '30rem'}}>
          ...
          <div className="card-body d-flex align-items-start text-center">
            <div className="col-3">
              <svg width="3em" height="3em" viewBox="0 0 16 16" className="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg width="3em" height="3em" viewBox="0 0 16 16" className="bi bi-envelope" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg width="3em" height="3em" viewBox="0 0 16 16" className="bi bi-key" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
